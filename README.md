...
3. Download and install the [Google Data Catalog JDBC Driver from CData](https://www.cdata.com/drivers/googledatacatalog/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
